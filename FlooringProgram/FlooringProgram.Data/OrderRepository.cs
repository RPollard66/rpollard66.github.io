...
namespace FlooringProgram.Data
{
 ...
 public class OrderRepository:IOrderRepository
 {
     ...
     public void SaveOrdersToFile(List<Order> allOrders, string fileName)
     {
         ...
         const string header = "OrderNumber|CustomerName|State|TaxPercent|ProductType|Area|CostPerSquareFoot|LaborCostPerSquareFoot|MaterialCost|LaborCost|Tax|Total";
